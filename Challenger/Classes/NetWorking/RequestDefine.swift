...
let RequestChallengeInfoUpdate = "/challenges/updateChallengeInfo"     //POST-更新挑战信息
let RequestChallengeLogUpdate = "/challenges/updateChallengeLog"       //POST-更新挑战记录
...
let RequestUserGameInfoUpdate = "/games/updateUserGameInfo"       //POST-更新用户指定游戏的信息
let RequestGameActorUpdate = "/games/updateGameActor"             //POST-更新游戏参与者信息
